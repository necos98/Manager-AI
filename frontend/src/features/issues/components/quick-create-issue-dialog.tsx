...
export function QuickCreateIssueDialog({ projectId, open, onOpenChange }: Props) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="quick-issue-description" className="text-sm font-medium mb-1.5 block">
