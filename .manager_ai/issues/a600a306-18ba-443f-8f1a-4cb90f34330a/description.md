Bug quando apro la pagina delle pipelines:


INFO:     127.0.0.1:64050 - "GET /api/pipelines HTTP/1.1" 500 Internal Server Error
ERROR:    Exception in ASGI application
  ...
  +-+---------------- 1 ----------------
    ...
    |            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |   File "C:\Users\j.magarelli\Desktop\manager-ai\Manager-AI\backend\app\routers\pipelines.py", line 42, in list_pipelines
    |     return [_response(p) for p in pipelines]
    |             ~~~~~~~~~^^^
    |   File "C:\Users\j.magarelli\Desktop\manager-ai\Manager-AI\backend\app\routers\pipelines.py", line 29, in _response
    ...
    | pydantic_core._pydantic_core.ValidationError: 1 validation error for PipelineResponse
    | project_id
    |   Field required [type=missing, input_value={'id': 'cd6bd6b5-9940-4a1...: '2026-05-27 19:25:23'}, input_type=dict]
