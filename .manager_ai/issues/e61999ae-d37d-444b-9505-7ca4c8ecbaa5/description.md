Bug quando aggiorno il nome di una pipeline:

INFO:     127.0.0.1:51154 - "PUT /api/pipelines/fae19dc5-1fd9-40e6-99da-1d989caa034f HTTP/1.1" 500 Internal Server Error
ERROR:    Exception in ASGI application
  ...
  +-+---------------- 1 ----------------
    ...
    |            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |   File "C:\Users\j.magarelli\Desktop\manager-ai\Manager-AI\backend\app\routers\pipelines.py", line 76, in update_pipeline
